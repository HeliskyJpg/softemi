      ...
      <div id="order-detail-main-content" className={`space-y-6 ${showReceiptModal ? 'no-print' : ''}`}>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-white hover:bg-[#FBECEF] text-[#681B2B] border border-[#F2D6DE] text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer shadow-xs focus:outline-hidden focus-visible:ring-2 focus-visible:ring-[#681B2B]/20"
