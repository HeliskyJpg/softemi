      ...
      >
        ...
        {clientOrders.length === 0 ? (
          <div className="py-12 text-center">
            <div className="w-12 h-12 rounded-full bg-[#FBECEF] text-[#681B2B] flex items-center justify-center mx-auto mb-2">
                  ...
                  {clientOrders.map((order) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 text-[#2C1E23]">
                        <div className="flex items-center gap-1.5">
                          <Calendar className="w-3.5 h-3.5 text-[#7D6871]" />
                          <span>{order.deliveryDate}</span>
                          {order.deliveryTime && (
                            <span className="text-[#7D6871] text-[11px]">
                              ({order.deliveryTime})
                            </span>
                          )}
                        </div>
            ...
            <div className="flex items-start justify-between gap-3 p-4 sm:p-6 pb-3 sm:pb-4 border-b border-[#F2D6DE]/60 shrink-0">
              <div className="min-w-0 flex-1 pr-2">
                ...
                <p className="text-xs text-[#7D6871] mt-0.5 leading-relaxed break-words">
                  Actualice la información de contacto y gustos florales.
                </p>
              </div>
              <button
